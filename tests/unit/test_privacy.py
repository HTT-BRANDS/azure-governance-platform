...
class TestConsentPreferences:
    ...
    def test_custom_values(self):
        ...
        prefs = ConsentPreferences(necessary=True, functional=True, analytics=True, marketing=False)
...
class TestPrivacyRoutes:
    ...
    def test_save_consent_ensures_necessary(self):
        ...
        response = self.client.post(
            "/api/v1/privacy/consent/preferences", json={"necessary": False, "analytics": True}
        )
